...
<ParamField path="STRIX_SUBAGENT_LLM" type="string">
  Optional dedicated model for delegated subagents. When unset, subagents reuse `STRIX_LLM`.
</ParamField>

<ParamField path="STRIX_SUBAGENT_LLM_API_KEY" type="string">
  Optional API key override for the subagent model. Falls back to `LLM_API_KEY`.
</ParamField>

<ParamField path="STRIX_SUBAGENT_LLM_API_BASE" type="string">
  Optional API base override for the subagent model. Falls back to `LLM_API_BASE` and related base URL settings.
</ParamField>
...
# Optional: use a different model for delegated subagents
