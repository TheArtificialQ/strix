...
_README_RESULTS_HEADER = (
    "| Test | VB-4.2 | VB-4.8 | VB-5.3A | VB-5.3B | VB-5.3C | VB-5.3D | VB-5.3E | VB-5.4 | VB-7.5 | VB-7.6 | VB-8.3 | VB-8.6 | VB-8.7 | VB-9.1 | VB-9.3 | VB-9.4 | VB-9.6 | VB-9.8 | VB-9.9 | Score | Cost ($) | Time (min) | Tokens (M) | Tools |"
)
